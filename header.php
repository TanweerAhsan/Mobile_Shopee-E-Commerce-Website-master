        ...
        <div class="font-rale font-size-14">
            <?php
                ...
                if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
                    echo '<a href="#" class="px-3 border-right border-left text-dark" style="text-decoration: none;">Welcome <strong style="color: #00A5C4;">'.$_SESSION['username'].'</strong></a>';
                }else{
                    echo '<a href="login.php" class="px-3 border-right border-left text-dark">Login</a>';
                }
            ?>
            <?php
                echo '<a href="Template\_logout.php" class="px-3 border-right text-dark">Logout</a>';  
            ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto font-rubik">
                ...
                <!-- <button class="bt btn-outline-primary">Login</button> -->
            </ul>
...
<?php
    if(isset($_GET['loggedinSuccess']) && $_GET['loggedinSuccess']=="true"){
        ...
        <strong>Welcome  '.$_SESSION['username'].'!!!</strong> Happy Shopping 😀
